      ...
      <div class="col-md-8">
        <div class="box_general padding_bottom">
          <div class="header_box version_2">
            ...
            <table id="zctb" class="display table table-striped table-bordered table-hover table-responsive" cellpadding="0" contenteditable="0" cellspacing="0" width="50">
                  <thead>
                    <tr>
                      <th>#</th>
                  ...
                  if (isset($_SESSION['user_email'])) {
                    ...
                    <tr>
                      ...
                      <td><?php echo htmlentities($row['transaction_date']);?></td>
                      <td><?php echo htmlentities($row['name']);?></td>
                      <td><?php echo htmlentities('$'. $row['credit']);?></td>
                      <td><?php echo htmlentities( '$'. $row['debit']);?></td>
